...
<script>
  export default {
      ...
      acceptedEmployeesCount() {
        return this.acceptedEmployees
          .filter(employee => {
            ...
            return employee.hiredAt.isSameOrBefore(this.lastDay)
              && (typeof employee.hiredTo === 'undefined' || employee.hiredTo.isAfter(this.lastDay));
          }).length;
      },
    ...
    i18n: {
      messages: {
        pl: {
          'count-accepted': '{0} osób na koniec miesiąca',
          'count-accepted-plus-potential': '{0} osób na koniec miesiąca + {1} osób potencjalnych',
        },
        en: {
          'count-accepted': '{0} people on the end of month',
          'count-accepted-plus-potential': '{0} people on the end of month + {1} potential people',
        },
      },
    },
  };
