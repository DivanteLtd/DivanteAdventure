...
class ListWithDetailsActionTest extends AbstractEmployeesTest
{
    ...
    {
        $response = $this->request("GET", "/api/employees/details", $this->user1);
        ...
        $this->assertArrayHasKey('email', $firstValue);
        $this->assertEquals($employee->getEmail(), $firstValue['email']);
    }
}
